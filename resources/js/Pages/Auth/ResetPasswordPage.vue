        ...
        <main class="mx-auto flex max-w-7xl items-start justify-center px-4 py-12 sm:px-6 lg:px-8 lg:py-20">
            <div class="w-full max-w-md">
                <div class="text-center">
                    <h1 class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Create a new password</h1>
                    <p class="mt-2 text-sm text-gray-500">Choose a password that is easy for you to remember but hard for others to guess.</p>
                </div>

                <div v-if="form.errors.email || form.errors.password || form.errors.token" class="mt-6 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800">
